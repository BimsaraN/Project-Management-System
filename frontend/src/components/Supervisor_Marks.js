...
function Supervisor_Marks() {
    ...
    const setSubjectForm = (e) => {
        ...
        if (e.target.value == "proposal") {
            ...
            setMarksType2("Functionalities Management")
            setMarksType3("Time Management")
        } else if (e.target.value == "final_thesis") {
            setMarksType1("Documentation Standards")
            setMarksType2("Plagrism")
            setMarksType3("Communication Skills")
        } else if (e.target.value == "logbook") {
            setMarksType1("Documentation Standards")
            setMarksType2("Plagrism")
            setMarksType3("Detail Management")
        } else if(e.target.value == "status document 2"){
            setMarksType1("Documentation Standards")
            setMarksType2("Plagrism")
            setMarksType3("Detail Management")
        }else {
            setMarksType1("Documentation Standards")
            setMarksType2("Plagrism")
            setMarksType3("Functionalities Management")
        }
        if(e.target.value !== ""){
            setMode(true)
        }else{
                                ...
                                <Grid item xs={12}>
                                    <FormControl variant="standard" style={{ width: '50%' }}>
                                        ...
                                        <Select
                                            ...
                                            label="Subject"
                                        >
                                            <MenuItem value={"status1"}>Status Document 1</MenuItem>
                                            <MenuItem value={"status2"}>Status Document 2</MenuItem>
                                            <MenuItem value={"proposal"}>Proposal</MenuItem>
                                            <MenuItem value={"logbook"}>Log Book</MenuItem>
                                            <MenuItem value={"final_thesis"}>Final Thesis</MenuItem>
                                        </Select>
                                    </FormControl>
                                </Grid>
                                {mode && (
...
export default Supervisor_Marks;
